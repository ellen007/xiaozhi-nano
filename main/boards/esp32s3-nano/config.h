...
#define NANO_ENABLE_RGB_LED 0
// Nano LED population is unverified; only used after explicit enable.
#define NANO_RGB_LED_COUNT 1
...
// Reserved ADC: no battery percentage without divider/calibration data.
#define POWER_ADC_PIN GPIO_NUM_8
// Digital touch module only; this is not the native capacitive-touch driver.
#define TOUCH_BUTTON_GPIO GPIO_NUM_1
#define NANO_ENABLE_TOUCH_BUTTON 0
#define NANO_TOUCH_ACTIVE_HIGH false
